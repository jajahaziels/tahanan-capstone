                    ...
                    <div class="settings-item" id="codeOfConductBtn">
                        <div class="settings-item-info">
                            ...
                            <div class="settings-item-text">
                                ...
                                <p>Community guidelines and conduct</p>
                            </div>
                        </div>
                        <i class="fa-solid fa-chevron-right settings-item-arrow"></i>
                    </div>
        ...
        <div class="terms-container">
            ...
            <div class="terms-content">
                ...
                <section>
                    ...
                    <p>Landlords must provide accurate property information including location, amenities, rental price, and safety features. Your data is handled according to privacy laws.</p>
                </section>
                <section>
                    <h2>2. Respect and Truthfulness</h2>
                    <p>Maintain respectful interactions with tenants. False listings or offensive messages are prohibited and will result in account suspension.</p>
                </section>
                <section>
                    <h2>3. Communication Policy</h2>
                    <p>Use real-time chat responsibly for property-related communication. Respond to tenant inquiries promptly.</p>
                </section>
                <section>
                    <h2>4. Proximity Mapping &amp; Safety</h2>
                    <p>Ensure proximity mapping coordinates are accurate to help tenants verify property locations and assess surrounding safety.</p>
                </section>
                <section>
                    <h2>5. Payment Reminders</h2>
                    <p>Automatic rent payment reminders are provided as a courtesy. Map Aware Home does not process transactions.</p>
                </section>
                <section>
            ...
            <div class="terms-content">
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li>Terms must be clearly stated before proceeding</li>
        ...
        <div class="terms-container">
            ...
            <div class="terms-content">
                ...
                <section>
                    ...
                    <ul>
                        <li>Full legal names and contact info of all parties</li>
                ...
                <section>
                    ...
                    <ul>
                        <li>Map Aware Home is not liable for contract breaches or personal disputes</li>
