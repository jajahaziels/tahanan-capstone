...
// Fetch landlord listings WITH PRICE
$sql = "
    SELECT 
        ID AS listing_id, 
        listingName, 
    ...
    `;
            ...
            listings.forEach(item => {
                ...
                const marker = new google.maps.Marker({
                    map, position: pos, title: item.listingName,
                    icon: {
                        url: `http://maps.google.com/mapfiles/ms/icons/${getPriceColor(item.price)}-dot.png`,
            ...
            hospitals.forEach(h => {
                new google.maps.Marker({
                    map, position: { lat: h.lat, lng: h.lng }, title: h.name,
                    icon: { url: "https://maps.google.com/mapfiles/ms/icons/hospitals.png", scaledSize: new google.maps.Size(32, 32) }
                });
            ...
            evacCenters.forEach(e => {
                new google.maps.Marker({
                    map, position: { lat: e.lat, lng: e.lng }, title: e.name,
