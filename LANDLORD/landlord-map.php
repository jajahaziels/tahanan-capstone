...
<body>
   ...
   content.innerHTML = `
    ...
    <ul class="hazard-list">
        ...
        <li><strong>NDRRMC Operations Center:</strong> (02) 8911-1406 / 8911-1873</li>        <li><strong>San Pedro, Laguna CDRRMO:</strong> (02) 8403-2648 / 0998 594 1743</li>
        <li><strong>Philippine Red Cross:</strong> 143</li>
            ...
            content.innerHTML = `
                ...
                <p style="font-size:12px;color:#999;font-weight:600;margin:0 0 10px;">San Pedro, Laguna · West (PHIVOLCS)</p>
                ...
                <p style="font-size:13px;color:#555;font-weight:600;line-height:1.6;margin:8px 0 12px;">
                    San Pedro City sitsValley Fault  along the <strong>West Valley Fault (WVF)</strong>, part of the Valley Fault System. 
