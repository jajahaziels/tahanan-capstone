...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($description) || empty($category) || empty($priority)) {
        ...
        if (isset($_FILES['photo']) && $_FILES['photo']['error'] === UPLOAD_ERR_OK) {
            ...
            $webPath = 'tahanan/uploads/maintenance/';
...
<head>
    ...
    <style>
        * { font-family: "Montserrat", sans-serif; }
        ...
        .container { margin-top: 150px; margin-bottom: 50px; }
        .form-card {
            background: #ffffff;
            border-radius: 14px;
            padding: 30px;
        ...
        .form-card h2 { font-weight: 600; margin-bottom: 10px; color: #25343F; }
        .property-info { background: #f8f9fa; padding: 15px; border-radius: 8px; margin-bottom: 25px; }
        .form-label { font-weight: 600; color: #25343F; margin-bottom: 8px; }
        ...
        .btn-submit {
            background: #ac1152; color: white; border: none;
            padding: 12px 40px; border-radius: 25px; font-weight: 600; transition: all 0.3s;
        }
        .btn-submit:hover {
            background: #8d0b41;
        ...
        .btn-back {
            background: transparent; color: #ac1152; border: 2px solid #ac1152;
            padding: 10px 30px; border-radius: 25px; font-weight: 600; transition: all 0.3s;
        }
        .btn-back:hover { background: #ac1152; color: white; }
