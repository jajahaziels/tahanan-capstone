...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 05, 2026 at 02:18 PM
...
(2, 'private', 'Chat about Sunny Studio Apartment', '2026-02-05 08:03:20'),
(3, 'private', 'Chat about Magandang bahay', '2026-02-05 13:12:11');
...
(3, 2, 'tenant', 7, '2026-02-05 08:03:20', NULL),
(4, 2, 'landlord', 1, '2026-02-05 08:03:20', NULL),
(5, 3, 'tenant', 7, '2026-02-05 13:12:11', NULL),
(6, 3, 'landlord', 3, '2026-02-05 13:12:11', NULL);
...
(3, NULL, 'samuel landlord', NULL, NULL, 'psalmuelalcazar30@gmail.com', '$2y$10$NYDuwQs1TsqT.nmM4PNZbe9Ow3gl9cmRjMjM7KRdK6xavajJ3/c8i', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'pending', '2026-02-05 07:10:34', 'verified', 'uploads/ids/1770285855_1900x1900-000000-80-0-0.jpg', 'uploads/verification/3_valid_id_1770289381.jpg', 'uploads/verification/3_proof_of_ownership_1770289381.jpg', 'uploads/verification/3_landlord_insurance_1770289381.jpg', 'uploads/verification/3_gas_safety_cert_1770289381.jpg', 'uploads/verification/3_electric_safety_cert_1770289381.jpg', 'uploads/verification/3_lease_agreement_1770289381.docx', NULL, '2026-02-05 19:03:01', '2026-02-05 21:03:54');
...
(12, 'Magandang bahay', 676767, 'maganda to pramis', '[\"1770297114_6984971addd50_be7cff0e3f0046dc8d36d24201af422cH3000W3000_464_464.jpg\"]', 'blk 21 lot 3', 'Bagong Silang', 0, '2026-02-05', 'Condominium', 3, 14.3652379, 121.0509467, 'available');
...
CREATE TABLE `messages` (
  ...
  `sender_type` enum('tenant','landlord') NOT NULL DEFAULT 'tenant',
...
(1, 1, 1, 'tenant', 'Hi! I\'m interested in your property: Sunny Studio Apartment.', NULL, NULL, NULL, 'text', 'active', '2025-11-08 01:55:17', NULL, 0),
(2, 2, 7, 'tenant', 'Hi! I\'m interested in your property: Sunny Studio Apartment.', NULL, NULL, NULL, 'text', 'active', '2026-02-05 08:03:20', NULL, 0),
(3, 3, 7, 'tenant', 'Hi! I\'m interested in your property: Magandang bahay.', NULL, NULL, NULL, 'text', 'active', '2026-02-05 13:12:11', NULL, 0),
(4, 3, 3, 'landlord', 'oki', NULL, NULL, NULL, 'text', 'active', '2026-02-05 13:12:17', NULL, 0);
...
(7, 'samuel tenant', '', '', NULL, 'minceydicey@gmail.com', '$2y$10$Y0//R9Iu/wPH9666EWJfe.aDw2HcKbIFA4ZEiM9Bg1vaFVL5dbtu6', NULL, NULL, NULL, NULL, '2026-02-05 07:34:41', 'pending', NULL);
...
(3, 3, '9d37f950beb0e85a86b77094a2e09cef7957813df5b7e8305a84629b2ae77231', '::1', '2026-02-05 15:11:21', 'landlord'),
(4, 2, '9d37f950beb0e85a86b77094a2e09cef7957813df5b7e8305a84629b2ae77231', '::1', '2026-02-05 15:11:56', 'landlord'),
(5, 7, '9d37f950beb0e85a86b77094a2e09cef7957813df5b7e8305a84629b2ae77231', '::1', '2026-02-05 15:36:21', 'tenant');
...
ALTER TABLE `reviews`
  ...
  ADD KEY `idx_landlord_created` (`landlord_id`,`created_at`),
...
--
ALTER TABLE `properties`
  ADD CONSTRAINT `fk_properties_landlord` FOREIGN KEY (`landlord_id`) REFERENCES `landlordtbl` (`ID`) ON DELETE CASCADE;

--
-- Constraints for table `rental_agreements`
--
ALTER TABLE `rental_agreements`
  ADD CONSTRAINT `fk_agreements_landlord` FOREIGN KEY (`landlord_id`) REFERENCES `landlordtbl` (`ID`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_agreements_tenant` FOREIGN KEY (`tenant_id`) REFERENCES `tenanttbl` (`ID`) ON DELETE CASCADE;
...
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `fk_reviews_landlord` FOREIGN KEY (`landlord_id`) REFERENCES `landlordtbl` (`ID`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_reviews_tenant` FOREIGN KEY (`tenant_id`) REFERENCES `tenanttbl` (`ID`) ON DELETE CASCADE;
COMMIT;
